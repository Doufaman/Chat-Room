...
from common.protocol import set_client_message, TYPE_JOIN, TYPE_CHAT, TYPE_LEAVE, safe_print
...
class ChatClient:
    ...
    def join_server(self, server_id, server_host=SERVER_HOST):
        ...
        try:
            ...
            send_tcp_message(self.client_socket, msg)
    ...
    def receive_messages(self):
        ...
        try:
            while True:
                message = receive_tcp_message(self.client_socket)
                if message is None:
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python main.py <userid> <server_id>")
        print("Example: python main.py Bob 1")
        print("         (connects to server 1 on port 8001)")
        sys.exit(1)
